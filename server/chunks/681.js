...
const AnimatedText = ({ text , className =""  })=>{
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
        ...
        text-dark font-bold capitalize dark:text-light text-monserat
        ${className} `,
...
const Layout = ({ children , className =""  })=>{
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
        className: `${className} w-full h-full inline-block z-0 bg-light p-32 dark:bg-dark dark:text-light
